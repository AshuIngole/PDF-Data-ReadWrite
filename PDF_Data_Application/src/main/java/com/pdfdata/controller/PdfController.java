...
import com.pdfdata.service.PdfService;
import java.io.*;
//post Mapping:localhost:8383/pdf/createpdf
// for getMapping: localhost:8383/pdf/getpdf/name of the pdf
@Controller
@RequestMapping("/pdf")
public class PdfController {

    private static final String PDF_FILE_PATH = "C:\\PdfData\\";
